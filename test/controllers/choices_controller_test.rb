...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { order_id: @choice.order_id, person_id: @choice.person_id, product_id: @choice.product_id }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { order_id: @choice.order_id, person_id: @choice.person_id, product_id: @choice.product_id }
    assert_redirected_to choice_path(assigns(:choice))
  end
